...
# code for button checking --> button goes to 98
# initialize reg3 at 98
nop
nop
nop
nop
...
start:
bne $6, $0, custom #if reg6 != 0, then go to custom
...
check_8:
bne $17, $0, check_9 #if not equal to 0, go to start
blt $4, $21, check_9 #if duty cycle < 1, go to start
sub $4, $4, $21

check_9:
addi $5, $0, 0 #default state is 0 duty cycle
bne $9, $21, delay #if reg9 != 1, then delay 
addi $5, $0, 80 #if reg9 = 1, open 5 to 60 duty cycle
...
nop
nop
addi $1, $0, 27 #move servo1 halfway
nop
nop
nop
nop
...
nop
nop
addi $4, $0, 62 # Move it other half
addi $3, $0, 52 
addi $2, $0, 53
addi $1, $0, 57
nop
...
nop
nop
addi $4, $0, 56 #get in drop position
addi $3, $0, 38
addi $1, $0, 30
nop
nop
...
nop
nop
addi $4, $0, 50 #get in drop position
addi $3, $0, 24
addi $1, $0, 60 #move servo1 other half
nop
nop
nop
nop
...
nop
nop
addi $5, $0, 80 #open claw to drop object
nop
nop
nop
nop
